...
fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/listNasional.json?_='+date, {
        method: 'get',
...
fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/'+provinsi+'/listDps.json?_='+date, {
        method: 'get',
        headers: { Cookie: "_ga=GA1.3.1275283654.1542587633; _gid=GA1.3.2036981340.1542710926;", 'Content-Type': 'application/json' },
    })
    .then(res => res.text())
...
fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/'+provinsi+'/'+kota+'/listDps.json?_='+date, {
        method: 'get',
        headers: { Cookie: "_ga=GA1.3.1275283654.1542587633; _gid=GA1.3.2036981340.1542710926;", 'Content-Type': 'application/json' },
    })
    .then(res => res.text())
...
fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/'+provinsi+'/'+kota+'/'+kecamatan+'/listDps.json?_='+date, {
        method: 'get',
        headers: { Cookie: "_ga=GA1.3.1275283654.1542587633; _gid=GA1.3.2036981340.1542710926;", 'Content-Type': 'application/json' },
    })
    .then(res => res.text())
...
fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/'+provinsi+'/'+kota+'/'+kecamatan+'/'+kelurahan+'/listDps.json?_='+date, {
        method: 'get',
        headers: { Cookie: "_ga=GA1.3.1275283654.1542587633; _gid=GA1.3.2036981340.1542710926;", 'Content-Type': 'application/json' },
    })
...
// const getProvinsi = () => fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/listNasional.json?_='+date);
// // const getKabupaten = (provinsi) => fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/'+provinsi+'/listDps.json?_='+date);
// // const getKecamatan = (provinsi, kabupaten) => fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/'+provinsi+'/'+kabupaten+'/listDps.json?_='+date);
// // const getKelurahan = (provinsi, kabupaten, kecamatan) => fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/'+provinsi+'/'+kabupaten+'/'+kecamatan+'/listDps.json?_='+date);
// // const getTps = (provinsi, kabupaten, kecamatan, kelurahan) => fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/'+provinsi+'/'+kabupaten+'/'+kecamatan+'/'+kelurahan+'/listDps.json?_='+date);
// // const getDpt = (provinsi, kabupaten, kecamatan, kelurahan, tps) => fetch('https://infopemilu.kpu.go.id/pilkada2018/pemilih/dpt/1/'+provinsi+'/'+kabupaten+'/'+kecamatan+'/'+kelurahan+'/'+tps+'/listDps.json?_='+date);
